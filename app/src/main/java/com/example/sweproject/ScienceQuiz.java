...
public class ScienceQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button Finish = (Button) findViewById(R.id.FinishScience);
        Finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean add = false;
                if (dataBaseHelper.checkAssessmentTaken(MainActivity.Studentusername, "Science")) {
                    add = dataBaseHelper.changePerformance(MainActivity.Studentusername, score, "Science");
                } else {
                    add = dataBaseHelper.addPerformance(MainActivity.Studentusername, score, "Science");
                }
                if (add) {
                    Log.i("message", "true");
                } else {
                ...
                TextView scorefield = (TextView) findViewById(R.id.sciencescore);
                String scoreF = "Your Science Assessment Score: " + score * 100 + "%";
                scorefield.setText(scoreF);
                // startActivity(new Intent(MathQuiz.this, studentscorepage.class));
            }
        });
    }
}
